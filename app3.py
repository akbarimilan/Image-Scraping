...
def index():
    if request.method == 'POST':
                try:
                    ...
                    client = pymongo.MongoClient("mongodb+srv://akbarimilan:<password>@cluster0.jezuhwy.mongodb.net/?retryWrites=true&w=majority")
                    bd = client['image_scraper']
                    db_coll = bd['img_scrap_data']
